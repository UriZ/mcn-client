        ...
        return (
            <div>
                ...
                <Drawer open={this.state.open} width="100%">
                    ...
                    <FilterDrawer filterName="currency" defaultChecked={userPref.currency} filterValues={["bitcoin", "dogecoin", "ether", "bitcoin Cash"]} onPreferenceChanged={this.onPreferenceChanged.bind(this)}/>
